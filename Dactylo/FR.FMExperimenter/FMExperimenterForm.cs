...
namespace PatternRecognition.FingerprintRecognition.Applications
{
    public partial class FMExperimenterForm : Form
    {
        ...
        public void btnVisualMatch_Click(object sender, EventArgs e)
        {
            if (tbxResources.Text == "")
            {
            ...
            VisualFingerprintMatchingFrm vm = new VisualFingerprintMatchingFrm(matcher, resourceProvider, tbxResources.Text);
            vm.form = this;
            vm.Show();
            Hide();
        }
        ...
        private void FMExperimenterForm_FormClosed(object sender, FormClosedEventArgs e)
        {
